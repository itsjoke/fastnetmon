...
class ban_settings_t {
    public:
        ban_settings_t() : enable_ban(false),
            ...
            ban_threshold_mbps(0), ban_threshold_flows(0), ban_threshold_pps(0),ban_time_secs(0) {
